define([],function(){
	...
	function QuerySectionQuestion(defaultValues){
		var privateState = {};
	...
	BaseModel.isParentOf(QuerySectionQuestion);
	
	//Create new class level validator object
	BaseModel.Validator.call(QuerySectionQuestion);
	
	var registerValidatorBackup = QuerySectionQuestion.registerValidator;
	
	QuerySectionQuestion.registerValidator = function(){
		var propName = arguments[0];
		if(!setterFunctions[propName].changed){
			var setterBackup = setterFunctions[propName];
			setterFunctions[arguments[0]] = function(){
				if( QuerySectionQuestion.isValid(this, propName, val) ){
	...
	QuerySectionQuestion.relations = relations;
	
	QuerySectionQuestion.prototype.isValid = function(){
		return QuerySectionQuestion.isValid(this);
	};
	
	QuerySectionQuestion.prototype.objModelName = "QuerySectionQuestion";
	
	return QuerySectionQuestion;
});