...
define([], function(){
	var repoMapping = {
		...
		employeeFeatures  : {
			model : "InternalusersObjService/employeeFeatures/Model",
			config : "InternalusersObjService/employeeFeatures/MF_Config",
			repository : "InternalusersObjService/employeeFeatures/Repository",
		},
		internalUsers_view  : {
		...
		MultiEntity  : {
			model : "MultiEntityObjService/MultiEntity/Model",
			config : "MultiEntityObjService/MultiEntity/MF_Config",
			repository : "MultiEntityObjService/MultiEntity/Repository",
		}
	};
